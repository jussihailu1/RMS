...
public class ReservationService {
	...
	public List<Reservation> findTodaysNotVisited() {
		return repo.findTodaysWhereNotVisited(LocalDate.now());
	}
	...
	public void toggleVisited(Integer id) {
		Reservation reservation = findById(id);
		reservation.setVisited(!reservation.getVisited());
		repo.save(reservation);
	}
